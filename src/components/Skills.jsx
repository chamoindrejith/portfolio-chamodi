...
const Skills = () => {
  return (
    <div
      id="skills"
      className="w-full sm:px-[10%] lg:px-[15%] mt-20 py-16 md:py-20 scroll-mt-20 items-center justify-center"
    >
      <h4 className="text-center mb-2 text-lg geistMono">Skills & Strengths</h4>
          ...
          {skillCategories.map((category, index) => {
            ...
            return (
              <Card
                key={index}
                size="sm"
                className="bg-gray-50/70 mx-auto w-11/12 max-w-smhover:translate-1 hover:shadow-orange-100 hover:scale-105 hover:bg-gray-100 transition-all duration-300"
              >
                <CardHeader>
