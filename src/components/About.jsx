...
const About = () => {
  return (
    <div
      id="about"
      className="w-full px-[15%] scroll-mt-20 h-full md:h-screen py-20 mb-20 flex flex-col items-center justify-center bg-gray-50/70"
    >
      <h4 className="text-center mb-2 text-lg geistMono">Introduction</h4>
      <h2 className="text-center text-5xl geistMono">Who <span className="text-orange-500"> I</span> Am</h2>

      <div>
        <div>
          <p className="text-center mt-10 text-gray-500 md:text-lg md:leading-8">
      ...
      <div className="w-full mt-10">
        <Card size="sm" className="mx-auto w-full max-w-sm bg-gray-50/20">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 md:gap-4 text-sm md:text-lg">
      ...
      <div className="w-fit mx-auto mt-12 flex px-8 py-2.5 border-gray-500 rounded-full border hover:bg-gray-800 hover:text-white hover:border-white hover:transition-all hover:duration-300">
        <Link
